...
public class ImageProcessingBenchmark
{
    ...
    public void Setup()
    {
        ...
        {
            // Simular contenido t�pico de una mesa de p�ker
            ...
            // A�adir algo de ruido para simular condiciones reales
