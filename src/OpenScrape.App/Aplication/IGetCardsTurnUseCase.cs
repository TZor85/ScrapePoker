...
{
    public class GetCardsTurnUseCaseRequest : BaseRequest
    {
    ...
    public interface IGetCardsTurnUseCase
    {
        Task<GetCardsTurnUseCaseResponse> ExecuteAsync(GetCardsTurnUseCaseRequest request);
    }
}
