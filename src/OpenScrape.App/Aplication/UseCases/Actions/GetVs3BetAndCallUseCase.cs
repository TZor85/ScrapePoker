...
{
    public class GetVs3BetAndCallUseCase : IGetVs3BetAndCallUseCase
    {
        public GetVs3BetAndCallUseCaseResponse Execute(GetVs3BetAndCallUseCaseRequest request)
        {
            var response = new GetVs3BetAndCallUseCaseResponse();
