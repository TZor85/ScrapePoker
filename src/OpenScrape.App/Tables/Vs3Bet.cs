...
namespace OpenScrape.App.Tables
{
    public static class Vs3Bet
    {
        ...
        private static readonly Dictionary<string, Dictionary<HeroActions3Bet, int>> BTNvs3BetBB = new Dictionary<string, Dictionary<HeroActions3Bet, int>>
        {
            ...
            { "QQ",  new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 100 } } },            
            { "QJs", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.Call, 100 } } },
            { "QTs", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 35 }, { HeroActions3Bet.Call, 65 } } },
            { "Q9s", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 25 }, { HeroActions3Bet.Fold, 75 } } },
            { "Q8s", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 5 }, { HeroActions3Bet.Fold, 95 } } },
            { "AJo", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 60 }, { HeroActions3Bet.MarginalCall, 20 }, { HeroActions3Bet.Fold, 20 } } },
            { "JJ", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.AllIn, 20 }, { HeroActions3Bet.FourBet, 70 }, { HeroActions3Bet.Call, 10 } } },
            { "JTs", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 5 }, { HeroActions3Bet.Call, 95 } } },
            { "ATo", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 30 }, { HeroActions3Bet.Fold, 70 } } },
            { "TT", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.AllIn, 15 }, { HeroActions3Bet.FourBet, 25 }, { HeroActions3Bet.Call, 60 } } },
            { "T9s", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 30 }, { HeroActions3Bet.MarginalCall, 30 }, { HeroActions3Bet.Fold, 40 } } },
            { "99", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 5 }, { HeroActions3Bet.Call, 95 } } },
            { "88", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 30 }, { HeroActions3Bet.Call, 70 } } },
            { "87s", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.MarginalCall, 35 }, { HeroActions3Bet.Fold, 65 } } },
            { "77", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 5 }, { HeroActions3Bet.MarginalCall, 55 }, { HeroActions3Bet.Fold, 40 } } },
            { "76s", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.MarginalCall, 40 }, { HeroActions3Bet.Fold, 60 } } },
            { "66", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.MarginalCall, 60 }, { HeroActions3Bet.Fold, 40} } },
            { "65s", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.MarginalCall, 40 }, { HeroActions3Bet.Fold, 60 } } },
            { "55", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 5 }, { HeroActions3Bet.MarginalCall, 35 }, { HeroActions3Bet.Fold, 60} } },
            { "54s", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.MarginalCall, 40 }, { HeroActions3Bet.Fold, 60 } } },
            { "44", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.MarginalCall, 25 }, { HeroActions3Bet.Fold, 75} } },
            { "33", new Dictionary<HeroActions3Bet, int> { { HeroActions3Bet.FourBet, 5 }, { HeroActions3Bet.Fold, 95 } } }
        };
